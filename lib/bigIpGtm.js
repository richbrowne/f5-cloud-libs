 ...
 *                    an error occurs
 */
BigIpGtm.prototype.updateServer = function(serverName, virtualServers, options) {
    var servers = [];
    var payload = {};
    ...
    if (options.datacenter) {
        payload.datacenter = options.datacenter;
    }
    ...
    return this.core.modify(
        '/tm/gtm/server/~' + this.partition + '~' + serverName, payload);
};
 ...
 *                    an error occurs
 */
BigIpGtm.prototype.updatePool = function(poolName, serverName, virtualServers, options) {
    var members = [];
    var payload = {};
    ...
    if (options.loadBalancingMode) {
        payload.loadBalancingMode = options.loadBalancingMode;
    }
 ...
 */
BigIpGtm.prototype.setPartition = function(partition) {
